...
Item.create!(name: 'Bara de poder', description: 'Una bara que brinda poder', effect: 'Aumenta tu multiplicador de score en 1.5x', user: Lore )
Item.create!(name: 'Shuriken', description: 'Arma lanzable japonesa', effect: 'Inhabilita un enemigo.', user: Tiwi )
Item.create!(name: 'Contraseña maestra', description: 'Una contraseña dinámica sincronizada con un computador cuántico.', effect: 'Tu contraseña no se puede cambiar.', user: Salata )
Item.create!(name: 'Uno Stacko', description: 'Juego de mesa', effect: 'Diviertete!', user: Tiwi )
Item.create!(name: 'MissingNo', description: 'Error del juego', effect: 'Error 500.', user: Tiwi )
Item.create!(name: 'Ichiban', description: 'Lipstick for men', effect: 'Ichiban!.', user: Tiwi )
